...
@Tag(name = "API for students avatars")
public class AvatarController {
    ...
    @Operation(summary = "Students avatar upload")
    ...
    @Operation(summary = "Students avatar download from db")
    ...
    @Operation(summary = "Students avatar download from file")
    ...
    @GetMapping("/page")
    @Operation(summary = "Get avatars page")
